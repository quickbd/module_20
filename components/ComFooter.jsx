"use client";
import footerlogo from "@/public/images/logo_footer.png";
  ...
  return (
    <div>
        ...
        <form action>
          <div className=" items-center justify-place-content-center text-center  ">
            <div className="md:mb-6 md:ml-auto">
              <p className="uppercase">Subscribe</p>
      ...
      <footer className="flex flex-col items-center bg-black text-center text-white">
            ...
            <div className="mb-6 text-left md:w-1/3 w-full">
              ...
              <div className="mt-6 flex  ">
                <a
                  href="#!"
                  type="button"
                  className="bg-[#20B15A] m-1 h-9 w-9 rounded-full border-0 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-[#E7515A]  hover:bg-opacity-3 hover:text-cyan-100 focus:outline-none focus:ring-0"
                  data-te-ripple-init
        ...
        {/* Copyright section */}
        <div
          className="container p-4 text-left text-[11px]"
